...
public class WeakCollectionSetDescriptor extends CallInterfaceDescriptor {
	...
	public WeakCollectionSetDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.WeakCollectionSet;
	}
	...
	protected WeakCollectionSetDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};