...
public class FastNewClosureDescriptor extends CallInterfaceDescriptor {
	public static int kDescriptorFlags = CallInterfaceDescriptorData.Flag.kNoFlags.ordinal();
	public static int kReturnCount = 1;
	
	public static enum ParameterIndices {
		__dummy(-1), 
		kSharedFunctionInfo(0),
		kFeedbackCell(1),
	...
	public FastNewClosureDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.FastNewClosure;
	}
	...
	protected FastNewClosureDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};