...
public class RegExpSearchFastDescriptor extends CallInterfaceDescriptor {
	...
	public RegExpSearchFastDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.RegExpSearchFast;
	}
	...
	protected RegExpSearchFastDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};