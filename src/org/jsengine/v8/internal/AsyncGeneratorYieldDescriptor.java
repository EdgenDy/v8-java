...
public class AsyncGeneratorYieldDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncGeneratorYieldDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncGeneratorYield;
	}
	...
	protected AsyncGeneratorYieldDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};