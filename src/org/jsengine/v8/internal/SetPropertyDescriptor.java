...
public class SetPropertyDescriptor extends CallInterfaceDescriptor {
	...
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.SetProperty;
	}
	...
	protected SetPropertyDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};