...
public class IterableToListWithSymbolLookupDescriptor extends CallInterfaceDescriptor {
	...
	public IterableToListWithSymbolLookupDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.IterableToListWithSymbolLookup;
	}
	...
	protected IterableToListWithSymbolLookupDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};