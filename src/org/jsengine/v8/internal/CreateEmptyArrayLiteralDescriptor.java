...
public class CreateEmptyArrayLiteralDescriptor extends CallInterfaceDescriptor {
	...
	public CreateEmptyArrayLiteralDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CreateEmptyArrayLiteral;
	}
	...
	protected CreateEmptyArrayLiteralDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};