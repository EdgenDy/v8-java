...
public class HasPropertyDescriptor extends CallInterfaceDescriptor {
	...
	public HasPropertyDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.HasProperty;
	}
	...
	protected HasPropertyDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};