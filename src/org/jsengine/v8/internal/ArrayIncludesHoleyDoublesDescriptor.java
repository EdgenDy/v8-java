...
public class ArrayIncludesHoleyDoublesDescriptor extends CallInterfaceDescriptor {
	...
	public ArrayIncludesHoleyDoublesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ArrayIncludesHoleyDoubles;
	}
	...
	protected ArrayIncludesHoleyDoublesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};