...
public class ThrowWasmTrapRemByZeroDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapRemByZeroDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapRemByZero;
	}
	...
	protected ThrowWasmTrapRemByZeroDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};