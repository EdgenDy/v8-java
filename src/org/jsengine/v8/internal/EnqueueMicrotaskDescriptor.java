...
public class EnqueueMicrotaskDescriptor extends CallInterfaceDescriptor {
	...
	public EnqueueMicrotaskDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.EnqueueMicrotask;
	}
	...
	protected EnqueueMicrotaskDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};