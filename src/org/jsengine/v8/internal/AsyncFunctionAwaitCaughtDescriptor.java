...
public class AsyncFunctionAwaitCaughtDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncFunctionAwaitCaughtDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncFunctionAwaitCaught;
	}
	...
	protected AsyncFunctionAwaitCaughtDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};