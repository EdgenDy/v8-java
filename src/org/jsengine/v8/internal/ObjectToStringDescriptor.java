...
public class ObjectToStringDescriptor extends CallInterfaceDescriptor {
	...
	public ObjectToStringDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ObjectToString;
	}
	...
	protected ObjectToStringDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};