...
public class CopyDataPropertiesDescriptor extends CallInterfaceDescriptor {
	...
	public CopyDataPropertiesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CopyDataProperties;
	}
	...
	protected CopyDataPropertiesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};