...
public class SetPropertyInLiteralDescriptor extends CallInterfaceDescriptor {
	...
	public SetPropertyInLiteralDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.SetPropertyInLiteral;
	}
	...
	protected SetPropertyInLiteralDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};