...
public class ArrayIncludesPackedDoublesDescriptor extends CallInterfaceDescriptor {
	...
	public ArrayIncludesPackedDoublesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ArrayIncludesPackedDoubles;
	}
	...
	protected ArrayIncludesPackedDoublesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};