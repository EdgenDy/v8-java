...
public class AsyncGeneratorAwaitCaughtDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncGeneratorAwaitCaughtDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncGeneratorAwaitCaught;
	}
	...
	protected AsyncGeneratorAwaitCaughtDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};