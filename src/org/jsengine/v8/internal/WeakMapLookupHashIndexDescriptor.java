...
public class WeakMapLookupHashIndexDescriptor extends CallInterfaceDescriptor {
	...
	public WeakMapLookupHashIndexDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.WeakMapLookupHashIndex;
	}
	...
	protected WeakMapLookupHashIndexDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};