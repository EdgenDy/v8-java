...
class ConstructForwardVarargsDescriptor extends CallInterfaceDescriptor {
	...
	public ConstructForwardVarargsDescriptor() {
		super(key());
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ConstructForwardVarargs;
	}
	...
	protected ConstructForwardVarargsDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};