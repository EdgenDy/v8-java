...
public class ArrayIncludesSmiOrObjectDescriptor extends CallInterfaceDescriptor {
	...
	public ArrayIncludesSmiOrObjectDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ArrayIncludesSmiOrObject;
	}
	...
	protected ArrayIncludesSmiOrObjectDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};