...
public class CreateGeneratorObjectDescriptor extends CallInterfaceDescriptor {
	...
	public CreateGeneratorObjectDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CreateGeneratorObject;
	}
	...
	protected CreateGeneratorObjectDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};