...
public class NewPromiseCapabilityDescriptor extends CallInterfaceDescriptor {
	...
	public NewPromiseCapabilityDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.NewPromiseCapability;
	}
	...
	protected NewPromiseCapabilityDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};