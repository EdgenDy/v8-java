...
public class IterableToListDescriptor extends CallInterfaceDescriptor {
	...
	public IterableToListDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.IterableToList;
	}
	...
	protected IterableToListDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};