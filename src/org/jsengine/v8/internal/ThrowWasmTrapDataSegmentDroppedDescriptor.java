...
public class ThrowWasmTrapDataSegmentDroppedDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapDataSegmentDroppedDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapDataSegmentDropped;
	}
	...
	protected ThrowWasmTrapDataSegmentDroppedDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};