...
public class AsyncFunctionRejectDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncFunctionRejectDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncFunctionReject;
	}
	...
	protected AsyncFunctionRejectDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};