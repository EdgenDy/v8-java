...
public class AsyncFunctionEnterDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncFunctionEnterDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncFunctionEnter;
	}
	...
	protected AsyncFunctionEnterDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};