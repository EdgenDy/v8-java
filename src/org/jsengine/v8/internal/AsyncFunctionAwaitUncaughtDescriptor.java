...
public class AsyncFunctionAwaitUncaughtDescriptor extends CallInterfaceDescriptor {
	public static int kDescriptorFlags = CallInterfaceDescriptorData.Flag.kNoFlags.ordinal();
	public static int kReturnCount = 1;
	
	public static enum ParameterIndices {
		__dummy(-1), 
		kAsyncFunctionObject(0),
		kValue(1),
	...
	public AsyncFunctionAwaitUncaughtDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncFunctionAwaitUncaught;
	}
	...
	protected AsyncFunctionAwaitUncaughtDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};