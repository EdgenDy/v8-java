...
public class ThrowWasmTrapElemSegmentDroppedDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapElemSegmentDroppedDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapElemSegmentDropped;
	}
	...
	protected ThrowWasmTrapElemSegmentDroppedDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};