...
public class CreateShallowObjectLiteralDescriptor extends CallInterfaceDescriptor {
	...
	public static enum ParameterIndices {
		...
		kFeedbackVector(0),
		kSlot(1),
		kObjectBoilerplateDescription(2), 
		kFlags(3),
	...
	public CreateShallowObjectLiteralDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CreateShallowObjectLiteral;
	}
	...
	protected CreateShallowObjectLiteralDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};