...
public class ForInEnumerateDescriptor extends CallInterfaceDescriptor {
	...
	public ForInEnumerateDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ForInEnumerate;
	}
	...
	protected ForInEnumerateDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};