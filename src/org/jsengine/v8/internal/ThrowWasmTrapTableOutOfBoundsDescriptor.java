...
public class ThrowWasmTrapTableOutOfBoundsDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapTableOutOfBoundsDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapTableOutOfBounds;
	}
	...
	protected ThrowWasmTrapTableOutOfBoundsDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};