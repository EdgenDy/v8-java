...
public class ThrowWasmTrapDivUnrepresentableDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapDivUnrepresentableDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapDivUnrepresentable;
	}
	...
	protected ThrowWasmTrapDivUnrepresentableDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};