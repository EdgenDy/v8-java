...
public class ForInFilterDescriptor extends CallInterfaceDescriptor {
	...
	public ForInFilterDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ForInFilter;
	}
	...
	protected ForInFilterDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};