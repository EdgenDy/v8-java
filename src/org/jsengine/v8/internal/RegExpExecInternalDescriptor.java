...
public class RegExpExecInternalDescriptor extends CallInterfaceDescriptor {
	...
	public RegExpExecInternalDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.RegExpExecInternal;
	}
	...
	protected RegExpExecInternalDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};