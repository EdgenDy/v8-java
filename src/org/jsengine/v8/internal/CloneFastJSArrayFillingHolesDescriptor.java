...
public class CloneFastJSArrayFillingHolesDescriptor extends CallInterfaceDescriptor {
	...
	public CloneFastJSArrayFillingHolesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CloneFastJSArrayFillingHoles;
	}
	...
	protected CloneFastJSArrayFillingHolesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};