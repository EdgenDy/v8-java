...
public class FindOrderedHashMapEntryDescriptor extends CallInterfaceDescriptor {
	...
	public FindOrderedHashMapEntryDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.FindOrderedHashMapEntry;
	}
	...
	protected FindOrderedHashMapEntryDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};