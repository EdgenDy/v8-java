...
public class CloneFastJSArrayDescriptor extends CallInterfaceDescriptor {
	...
	public CloneFastJSArrayDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CloneFastJSArray;
	}
	...
	protected CloneFastJSArrayDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};