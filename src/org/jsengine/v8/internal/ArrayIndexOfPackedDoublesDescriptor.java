...
public class ArrayIndexOfPackedDoublesDescriptor extends CallInterfaceDescriptor {
	...
	public ArrayIndexOfPackedDoublesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ArrayIndexOfPackedDoubles;
	}
	...
	protected ArrayIndexOfPackedDoublesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};