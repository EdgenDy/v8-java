...
public class ThrowWasmTrapFloatUnrepresentableDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapFloatUnrepresentableDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapFloatUnrepresentable;
	}
	...
	protected ThrowWasmTrapFloatUnrepresentableDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};