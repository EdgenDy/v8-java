...
public class FulfillPromiseDescriptor extends CallInterfaceDescriptor {
	...
	public FulfillPromiseDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.FulfillPromise;
	}
	...
	protected FulfillPromiseDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};