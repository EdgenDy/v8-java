...
public class AsyncGeneratorRejectDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncGeneratorRejectDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncGeneratorReject;
	}
	...
	protected AsyncGeneratorRejectDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};