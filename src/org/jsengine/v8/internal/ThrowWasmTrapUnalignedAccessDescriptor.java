...
public class ThrowWasmTrapUnalignedAccessDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapUnalignedAccessDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapUnalignedAccess;
	}
	...
	protected ThrowWasmTrapUnalignedAccessDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};