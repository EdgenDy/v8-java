...
public class WeakCollectionDeleteDescriptor extends CallInterfaceDescriptor {
	...
	public WeakCollectionDeleteDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.WeakCollectionDelete;
	}
	...
	protected WeakCollectionDeleteDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};