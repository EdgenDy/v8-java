...
public class ThrowWasmTrapFuncInvalidDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapFuncInvalidDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapFuncInvalid;
	}
	...
	protected ThrowWasmTrapFuncInvalidDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};