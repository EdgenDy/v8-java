...
public class MapIteratorToListDescriptor extends CallInterfaceDescriptor {
	...
	public MapIteratorToListDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.MapIteratorToList;
	}
	...
	protected MapIteratorToListDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};