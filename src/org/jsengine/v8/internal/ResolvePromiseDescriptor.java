...
public class ResolvePromiseDescriptor extends CallInterfaceDescriptor {
	...
	public ResolvePromiseDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ResolvePromise;
	}
	...
	protected ResolvePromiseDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};