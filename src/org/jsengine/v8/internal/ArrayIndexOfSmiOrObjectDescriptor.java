...
public class ArrayIndexOfSmiOrObjectDescriptor extends CallInterfaceDescriptor {
	...
	public ArrayIndexOfSmiOrObjectDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ArrayIndexOfSmiOrObject;
	}
	...
	protected ArrayIndexOfSmiOrObjectDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};