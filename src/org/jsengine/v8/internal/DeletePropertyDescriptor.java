...
public class DeletePropertyDescriptor extends CallInterfaceDescriptor {
	...
	public DeletePropertyDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.DeleteProperty;
	}
	...
	protected DeletePropertyDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};