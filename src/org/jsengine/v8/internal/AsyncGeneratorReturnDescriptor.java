...
public class AsyncGeneratorReturnDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncGeneratorReturnDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncGeneratorReturn;
	}
	...
	protected AsyncGeneratorReturnDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};