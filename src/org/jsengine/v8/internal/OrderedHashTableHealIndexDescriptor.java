...
public class OrderedHashTableHealIndexDescriptor extends CallInterfaceDescriptor {
	...
	public OrderedHashTableHealIndexDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.OrderedHashTableHealIndex;
	}
	...
	protected OrderedHashTableHealIndexDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};