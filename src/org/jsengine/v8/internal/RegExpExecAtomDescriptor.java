...
public class RegExpExecAtomDescriptor extends CallInterfaceDescriptor {
	...
	public RegExpExecAtomDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.RegExpExecAtom;
	}
	...
	protected RegExpExecAtomDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};