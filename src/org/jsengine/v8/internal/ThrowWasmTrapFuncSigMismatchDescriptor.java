...
public class ThrowWasmTrapFuncSigMismatchDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapFuncSigMismatchDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapFuncSigMismatch;
	}
	...
	protected ThrowWasmTrapFuncSigMismatchDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};