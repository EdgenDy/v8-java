...
public class ArrayIndexOfHoleyDoublesDescriptor extends CallInterfaceDescriptor {
	...
	public ArrayIndexOfHoleyDoublesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ArrayIndexOfHoleyDoubles;
	}
	...
	protected ArrayIndexOfHoleyDoublesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};