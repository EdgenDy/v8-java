...
public class SetDataPropertiesDescriptor extends CallInterfaceDescriptor {
	...
	public SetDataPropertiesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.SetDataProperties;
	}
	...
	protected SetDataPropertiesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};