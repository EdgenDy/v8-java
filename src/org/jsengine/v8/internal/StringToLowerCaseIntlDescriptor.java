...
public class StringToLowerCaseIntlDescriptor extends CallInterfaceDescriptor {
	...
	public StringToLowerCaseIntlDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.StringToLowerCaseIntl;
	}
	...
	protected StringToLowerCaseIntlDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};