...
public class AsyncGeneratorResumeNextDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncGeneratorResumeNextDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncGeneratorResumeNext;
	}
	...
	protected AsyncGeneratorResumeNextDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};