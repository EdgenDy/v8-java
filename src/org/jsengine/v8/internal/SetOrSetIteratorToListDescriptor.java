...
public class SetOrSetIteratorToListDescriptor extends CallInterfaceDescriptor {
	...
	public SetOrSetIteratorToListDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.SetOrSetIteratorToList;
	}
	...
	protected SetOrSetIteratorToListDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};