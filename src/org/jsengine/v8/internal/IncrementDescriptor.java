...
public class IncrementDescriptor extends CallInterfaceDescriptor {
	...
	public IncrementDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.Increment;
	}
	...
	protected IncrementDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};