...
public class CreateShallowArrayLiteralDescriptor extends CallInterfaceDescriptor {
	...
	public CreateShallowArrayLiteralDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CreateShallowArrayLiteral;
	}
	...
	protected CreateShallowArrayLiteralDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};