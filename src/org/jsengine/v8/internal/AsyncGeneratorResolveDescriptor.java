...
public class AsyncGeneratorResolveDescriptor extends CallInterfaceDescriptor {
	...
	public AsyncGeneratorResolveDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.AsyncGeneratorResolve;
	}
	...
	protected AsyncGeneratorResolveDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};