...
public class ThrowWasmTrapMemOutOfBoundsDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapMemOutOfBoundsDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapMemOutOfBounds;
	}
	...
	protected ThrowWasmTrapMemOutOfBoundsDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};