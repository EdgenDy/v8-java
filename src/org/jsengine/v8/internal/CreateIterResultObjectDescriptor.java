...
public class CreateIterResultObjectDescriptor extends CallInterfaceDescriptor {
	...
	public CreateIterResultObjectDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CreateIterResultObject;
	}
	...
	protected CreateIterResultObjectDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};