...
public class BitwiseNotDescriptor extends CallInterfaceDescriptor {
	...
	public BitwiseNotDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.BitwiseNot;
	}
	...
	protected BitwiseNotDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};