...
public class PromiseResolveThenableJobDescriptor extends CallInterfaceDescriptor {
	...
	public PromiseResolveThenableJobDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.PromiseResolveThenableJob;
	}
	...
	protected PromiseResolveThenableJobDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};