...
public class CopyFastSmiOrObjectElementsDescriptor extends CallInterfaceDescriptor {
	...
	public CopyFastSmiOrObjectElementsDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.CopyFastSmiOrObjectElements;
	}
	...
	protected CopyFastSmiOrObjectElementsDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};