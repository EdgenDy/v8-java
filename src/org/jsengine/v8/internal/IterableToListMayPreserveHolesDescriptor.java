...
public class IterableToListMayPreserveHolesDescriptor extends CallInterfaceDescriptor {
	...
	public IterableToListMayPreserveHolesDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.IterableToListMayPreserveHoles;
	}
	...
	protected IterableToListMayPreserveHolesDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};