...
public class ThrowWasmTrapDivByZeroDescriptor extends CallInterfaceDescriptor {
	...
	public ThrowWasmTrapDivByZeroDescriptor() {
		super(key()); 
	}
	
	public static CallDescriptors.Key key() {
		return CallDescriptors.Key.ThrowWasmTrapDivByZero;
	}
	...
	protected ThrowWasmTrapDivByZeroDescriptor(CallDescriptors.Key key) {
		super(key);
	}
};